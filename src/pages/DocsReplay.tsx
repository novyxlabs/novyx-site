      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 rounded-lg border border-border bg-[#18181B] p-4 text-sm text-gray-300 space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <li>SDK 2.7.0+ — <span className="font-mono text-gray-300">pip install novyx&gt;=2.7.0</span> / <span className="font-mono text-gray-300">npm install novyx@latest</span></li>
          </ul>
        </div>
